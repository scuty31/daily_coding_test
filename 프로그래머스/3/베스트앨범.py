def solution(genres, plays):
    ...
    play_list.sort(key=lambda x:(-x[2],-x[3], x[0]))
...
genres_input = ["classic", "pop", "classic", "classic", "pop"]
plays_input = [500, 600, 150, 800, 2500]

print(solution(genres_input, plays_input))